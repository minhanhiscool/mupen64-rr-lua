 ...
 * \remarks This function must be called from a thread that isn't directly or indirectly interlocked with the emulator
 * thread. Emulation will be paused until the operation completes.
 */
