 ...
 * \return The index of the chosen choice. If the user has chosen to not use modals, this function will return the index
 ...
 * \param hwnd The parent window. If nullptr, the main window will be used.
 * \return Whether the user answered Yes. If the user has chosen to not use modals, this function will return the value
 * specified by the user's preferences in the view. If the user has chosen to not show the dialog again, this function
 * will return the last choice.
 */
